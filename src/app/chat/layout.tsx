      ...
      <div className={`${inChat ? "hidden md:flex" : "flex"} flex-col w-full md:w-[360px] md:min-w-[360px] h-full border-r border-brd`}>
        <div className="flex items-center justify-between px-4 py-3 border-b border-brd">
          ...
          <div className="flex items-center gap-1">
            <button onClick={() => setShowGroup(true)} className="p-2 rounded-lg hover:bg-surface transition-colors" title="New group">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
            </button>
            <button onClick={() => setShowNew(true)} className="p-2 rounded-lg hover:bg-surface transition-colors" title="New chat">
            ...
            <button onClick={() => router.push("/settings")} className="p-2 rounded-lg hover:bg-surface transition-colors" title="Settings">
